...
pub fn derive_states(input: TokenStream) -> TokenStream {
    ...
    state_mutation_trait_path
        .segments
        .push(format_ident!("MutableState").into());

    let mut free_mutation_trait_path = base_trait_path.clone();
    free_mutation_trait_path
        .segments
    ...
    quote! {
        ...
        impl #impl_generics #free_mutation_trait_path for #struct_name #ty_generics #where_clause {
        }
    }
    .into()
}
